...
for epoch in range(num_epochs):
    ...
    epoch_train_loss_avg = epoch_train_loss / len(train_loader)
    ...
    epoch_test_loss_avg = epoch_test_loss / len(test_loader)
    test_losses.append(epoch_test_loss_avg)

  
    if epoch_test_loss_avg < best_loss:
        best_loss = epoch_test_loss_avg
        save_file_name = f"/home/wwj/chenqiliang/model.pth"
        torch.save(model.state_dict(), save_file_name)

    print("epoch is {}, train loss is {}, test loss is {}".format(
        epoch, epoch_train_loss_avg, epoch_test_loss_avg))
