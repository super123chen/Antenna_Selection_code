...
#a = 100
n = 8
X_orig = pd.read_csv(r"/home/wwj/chenqiliang/SVD/All-channel_matrix_p_15.csv").iloc[:, 1:]
X_orig = np.asarray(X_orig, np.float32)
dataset = X_orig.reshape(X_orig.shape[0],8,8,1)

label = pd.read_csv(r"/home/wwj/chenqiliang/SVD/capacity_labels_p_15.csv").iloc[:, 1]
