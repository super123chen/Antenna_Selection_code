...
a = 50
m = n = 8
dataset = pd.read_csv(open(r'/home/wwj/chenqiliang/wubiaoqian/All-channel_matrix_p_50.csv')).iloc[0:200000, 1:]
label_array = pd.read_csv(open(r'/home/wwj/chenqiliang/wubiaoqian/capacity_labels_p_50.csv')).iloc[0:200000, 1:]
...
print("capacity mean", fullChainCapacity_Mean)
