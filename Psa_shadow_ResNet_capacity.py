...
label = pd.read_csv(r'/home/wwj/chenqiliang/SVD/gain_labels_p_10.csv').iloc[:, 1]
...
class Resnet(nn.Module):
    def __init__(self, n_class):
        ...
        self.model0 = Sequential(
            ...
            Conv2d(in_channels=1, out_channels=64, kernel_size=(2, 2), stride=1, padding=1),
            BatchNorm2d(64),
            Shadow(64),
            ReLU(),
...
print(ResNet_Pre_np1)
print(ResNet_Pre_np1.shape)
